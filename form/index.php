...
<body>
	...
	<div class="frmbox">
		...
		<form id="form_refer">
			<!-- Add a cursor element for the typing effect -->
			...
			<div class="text"></div>
			<div class="frm_stp_1 stpsform transup">
				<h2>Patient Information</h2>
				<div class="quesalign">
					<h3>
						<svg height="10" width="11" fill="rgb(255, 112, 67)"><path d="M7.586 5L4.293 1.707 5.707.293 10.414 5 5.707 9.707 4.293 8.293z"></path><path d="M8 4v2H0V4z"></path></svg> Patient Name *</h3>
					...
					<a class="btnsfrmsokprev" href="/"><span class="icon"><img src="assets/images/chevron-right.svg" class=" arrreverse" alt="chevron-right"></span> Back To Home</a>
	...
	<div class="content">
		<div class="button-container">
			<input type="checkbox" id="micButton" class="mic-checkbox" value="0">
